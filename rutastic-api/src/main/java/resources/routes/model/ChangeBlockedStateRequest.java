...
public class ChangeBlockedStateRequest {

    private long requestedRouteId;
    private String action;
    private UserClaimedIdentity userClaimedIdentity;

    public ChangeBlockedStateRequest() {
    }

    public ChangeBlockedStateRequest(long requestedRouteId, String action, UserClaimedIdentity userClaimedIdentity) {
